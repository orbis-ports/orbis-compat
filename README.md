...
glibc does with `RLIMIT_STACK`. Not configurable: the knob that used to override it was removed on 2026-09-18 after a stale
`ORBIS_THREAD_STACK=0` in `/data/orbis-env.txt` cost a crash - a switch here can only point down.
